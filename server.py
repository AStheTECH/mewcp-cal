...
from cal_mcp.config import BREAKING_CHANGES, SERVER_VERSION, configure_logging
from cal_mcp.tools import register_tools

configure_logging()
logger = logging.getLogger("cal-mcp")

backend = HeaderCredentialBackend()
mcp = FastMCP("MewCP Cal MCP Server", version=SERVER_VERSION,
